/**
 * WebSocket message protocol — shared types between server and UI.
 */
...
export interface FileChangedMessage {
  ...
  /** Full workspace tree so the Explorer panel can refresh. */
  tree?: FileTreeNode[];
}
...
export type ClientMessage = ChatClientMessage | SubscribeClientMessage;
